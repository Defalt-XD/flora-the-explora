...
def window02(width, height):
    ...
    # Load images
    image1 = pygame.image.load("flowers/hibiscus.jpg")
    image2 = pygame.image.load("flowers/lavender.jpg")
    image3 = pygame.image.load("flowers/lilly.jpg")
    ...
    sound1 = pygame.mixer.Sound("flower_aud/hibiscus.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("flower_aud/lavender.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("flower_aud/lilly.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Hibiscus", True, (255,255,255))
        label2 = font.render("Lavender", True, (255,255,255))
        label3 = font.render("Lilly", True, (255,255,255))
