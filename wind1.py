...
def window1(width, height):
    ...
    #learn_window = importlib.import_module('learn_window')
    # Load background image
    background = pygame.image.load("frbg.jpg")
    background = pygame.transform.scale(background, (width, height))

    # Load images
    image1 = pygame.image.load("fruits/apple.jpg")
    image2 = pygame.image.load("fruits/appricot.jpg")
    image3 = pygame.image.load("fruits/banana.jpg")
    ...
    image3 = pygame.transform.scale(image3, image_size)
        ...
        # Load sounds
    sound1 = pygame.mixer.Sound("fruit_aud/Apple.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("fruit_aud/appricot.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("fruit_aud/Banana.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Apple", True, (255,255,255))
        label2 = font.render("Appricot", True, (255,255,255))
        label3 = font.render("Banana", True, (255,255,255))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if back_button.collidepoint(mouse_pos):
                    ...
                    learn_window(800, 600)  # Open the previous window (learn_window)
                    running_game = False  # Exit this window
                elif next_button.collidepoint(mouse_pos):
                    print("Next button clicked!")
                    from wind2 import window2
                    window2(800, 600)  # Open the next window (wind2)
                    running_game = False  # Close the current window
