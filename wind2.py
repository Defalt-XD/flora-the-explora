...
def window2(width, height):
    ...
    # Load images
    image1 = pygame.image.load("fruits/bluberry.jpg")
    image2 = pygame.image.load("fruits/coconut.jpg")
    image3 = pygame.image.load("fruits/grapes.jpg")
    ...
    #load sound
    sound1 = pygame.mixer.Sound("fruit_aud/blueberry.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("fruit_aud/coconut.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("fruit_aud/grapes.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Blueberry", True, (255,255,255))
        label2 = font.render("coconut", True, (255,255,255))
        label3 = font.render("Grapes", True, (255,255,255))
