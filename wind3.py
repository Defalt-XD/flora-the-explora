...
def window3(width, height):
    ...
    # Load images
    image1 = pygame.image.load("fruits/kiwi.jpg")
    image2 = pygame.image.load("fruits/orange.jpg")
    image3 = pygame.image.load("fruits/pine apple.jpg")
    ...
    sound1 = pygame.mixer.Sound("fruit_aud/kiwi.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("fruit_aud/orange.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("fruit_aud/pineapple.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Kiwi", True, (255,255,255))
        label2 = font.render("Orange", True, (255,255,255))
        label3 = font.render("Pine Apple", True, (255,255,255))
