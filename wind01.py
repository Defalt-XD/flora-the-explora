...
def window01(width, height):
    ...
    # Load images
    image1 = pygame.image.load("flowers/bluebell.jpg")
    image2 = pygame.image.load("flowers/cherry.jpg")
    image3 = pygame.image.load("flowers/daisy.jpg")
    ...
    sound1 = pygame.mixer.Sound("flower_aud/bluebell.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("flower_aud/cherry.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("flower_aud/daisy.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Bluebell", True, (255,255,255))
        label2 = font.render("Cherry", True, (255,255,255))
        label3 = font.render("Daisy", True,(255,255,255))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if back_button.collidepoint(mouse_pos):
                    ...
                    window02(800, 600)  # Open the next window (wind2)
