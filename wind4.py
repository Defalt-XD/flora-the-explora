...
def window4(width, height):
    ...
    # Load images
    image1 = pygame.image.load("fruits/plum.jpg")
    image2 = pygame.image.load("fruits/pomgranade.jpg")
    image3 = pygame.image.load("fruits/strawberry.jpg")
    ...
    sound1 = pygame.mixer.Sound("fruit_aud/plum.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("fruit_aud/pomgranade.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("fruit_aud/strawberry.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Plum", True, (255,255,255))
        label2 = font.render("Pomgarnade", True, (255,255,255))
        label3 = font.render("Strawberry", True, (255,255,255))
