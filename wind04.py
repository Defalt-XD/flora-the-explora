...
def window04(width, height):
    pygame.init()
    game_screen = pygame.display.set_mode((width, height))
    pygame.display.set_caption("Window 04")
    ...
    # Load images
    image1 = pygame.image.load("flowers/rose.jpg")
    image2 = pygame.image.load("flowers/sunflower.jpg")
    image3 = pygame.image.load("flowers/tulip.jpg")
    ...
    sound1 = pygame.mixer.Sound("flower_aud/rose.wav")  # Sound for the first image
    sound2 = pygame.mixer.Sound("flower_aud/sunflower.wav")   # Sound for the second image
    sound3 = pygame.mixer.Sound("flower_aud/tulip.wav")    # Sound for the third image
    ...
    while running_game:
        ...
        label1 = font.render("Rose", True, (255,255,255))
        label2 = font.render("Sunflower", True, (255,255,255))
        label3 = font.render("Tulip", True, (255,255,255))
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if back_button.collidepoint(mouse_pos):
                    ...
                    from wind03 import window03
                    window03(width, height)
